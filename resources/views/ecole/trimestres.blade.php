                    ...
                    <form method="PUT" action="{{ route('trimestres.update', $self->id) }}">
                        ...
                        <div class="flex gap-5">
                            ...
                            <div class="mt-4 w-full">
                                ...
                                <x-select :val="$self->annee_scolaire" :collection="$annees" :selected="$self->anne_scolaire" class="block mt-1 w-full"  name='annee_scolaire' required> </x-select>
                            </div>
                        </div>
                        <div class="flex gap-5">
                            <div class="mt-4 w-full">
                        ...
                        <tbody>
                                ...
                                @foreach ($items as $item)
                                    <tr class="">
                                        ...
                                        <td class="p-1 text-size-sm text-center align-middle bg-transparent border-b  shadow-transparent">{{$item->date_debut}}</td>
                                        <td class="p-1 text-size-sm text-center align-middle bg-transparent border-b  shadow-transparent">{{$item->date_fin}}</td>
                                        <td class="p-1 text-size-sm text-center align-middle bg-transparent border-b  shadow-transparent   text-blue-500 underline">
                                            <div class="flex justify-center gap-4 align-middle">
                                                <a href="{{ route('trimestres.edit',$item->id) }}"><i class="fa fa-solid fa-pen"></i></a>
