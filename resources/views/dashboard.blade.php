...
@section('content')
    ...
    <div class="w-full px-6 py-0.6 mx-auto">
        <!-- row 1 -->
        @if (Auth::user()->isAdmin() || Auth::user()->isDirecteur() || Auth::user()->isSecretaire() || Auth::user()->isManager())
                                ...
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <p class="mb-0 dark:text-white dark:opacity-60">
                                            <span
                                                class="font-bold leading-normal text-size-sm text-blue-500">Encadrées:</span>
                                            {{ $classesEncadrees }}
                                        </p>
                                        <p class="mb-0 dark:text-white dark:opacity-60">
                                            <span class="font-bold leading-normal text-size-sm text-red-500">Non
                                                Encadrées:</span>
                            ...
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <p class="mb-0 dark:text-white dark:opacity-60">
                                            <span
                                                class="font-bold leading-normal text-size-sm text-blue-500">Garcons:</span>
                                            {{ $garcons }}
                                        </p>
                                    </div>
                                </div>
                                <div class="px-3 text-right basis-1/3">
                                    <div
                                        ...
                                        <i
                                            class="fa fa-solid fa-chalkboard-user text-size-lg relative top-3.5 text-white"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <p class="mb-0 dark:text-white dark:opacity-60">
                                            <span
                                                class="font-bold leading-normal text-size-sm text-red-500">Inactifs:</span>
                                            {{ $users - $usersActifs }}
                                        </p>
                                    </div>
                                </div>
