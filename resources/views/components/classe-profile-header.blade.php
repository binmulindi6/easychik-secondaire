<div class="relative flex flex-col flex-auto min-w-0 p-4 overflow-hidden break-words bg-white border-0 dark:bg-slate-850 dark:shadow-dark-xl shadow-3xl rounded-2xl bg-clip-border">
    <div class="flex flex-wrap items-center -mx-3">
      <div class="flex-none w-auto max-w-full px-3">
        <div class="relative inline-flex items-center justify-center text-white transition-all duration-200 ease-in-out text-size-base h-19 w-19 shadow-xs rounded-xl">
      ...
      <div class="flex-none w-auto max-w-full px-3 my-auto">
        <div class="h-full flex flex-col">
              ...
              <span class="uppercase text-3 font-semibold dark:text-white">Nombre d'élèves : {{count($data->eleves())}}</span>
              <span class="uppercase text-3 font-semibold dark:text-white">Filles : {{count($data->filles())}}</span>
              <span class="uppercase text-3 font-semibold dark:text-white">Garçons : {{count($data->garcons())}}</span>
        </div>
      </div>
      <div class="w-full max-w-full px-3 mx-auto mt-4 sm:my-auto sm:mr-0 md:w-1/2 md:flex-none lg:w-4/12">
        <div class="relative hidden right-0">
