    ...
    @if (isset($joker))
        ...
        @else
            <div class="flex flex-row gap-4 sm-max:justify-center">
                ...
                @if ($pagename != 'Eleves/Create' && $pagename != 'Eleves')
                    <a class="w-full" href="{{ route('eleves.create') }}">
                        <div>
                            <i
                                class="relative top-0 leading-normal text-green-500 fa fa-solid fa-plus text-size-sm"></i>
                            <span
                                class="ml-1 duration-300 opacity-100 pointer-events-none  ease sm-max:text-size-xs">Ajouter
                                un
                                Eleve</span>
                        </div>
                    </a>
            ...
            <div
                ...
                @if ($pagename != 'Eleves' && $pagename != 'Eleves/Create' && $pagename != 'Eleves/Edit')
                    <a href="{{ route('eleves.index') }}">
                        <div>
                            <i
                                class="relative top-0 leading-normal text-orange-500 fa fa-solid fa-user text-size-sm"></i>
                            <span
                                class="ml-1 duration-300 opacity-100 pointer-events-none  ease sm-max:text-size-xs">Eleves</span>
                        </div>
                    </a>
            ...
            @else
                <div>
                    <i class="relative top-0 leading-normal text-green-500 fa fa-solid fa-plus text-size-sm"></i>
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none  ease sm-max:text-size-xs">Ajouter
                        une
                        Frequentation</span>
                </div>
            @endif
            ...
            <div
                ...
                @if ($pagename != 'Frequentations' && $pagename != 'Frequentations/Create')
                    <a href="{{ route('frequentations.index') }}">
                        <div>
                            <i
                                class="relative top-0 leading-normal text-black fa fa-solid fa-bar-chart text-size-sm"></i>
                            <span
        ...
        <div
            ...
            <a href="{{ route('import.excel.index') }}">
                <div>
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none  ease sm-max:text-size-xs">Importer
                        Eleves</span>
                </div>
            </a>
            {{-- @endif --}}
