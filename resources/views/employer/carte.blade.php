            ...
            <div id="card-front" class="card-container p-10">
                <div class="flex flex-row gap-5 items-center justify-between w-full border-b-8 border-black ">
                    ...
                    <div class="card-front-titles">
                        ...
                        <span
                            class="text-9 font-bold uppercase">{{ $ecole->nom ? $ecole->nom : env('APP_NAME') }}</span>
                    </div>
                    <img class="icons" src="{{ asset('storage/armoirie.png') }}" alt="armoirie">
                </div>
                <div class="joker">
                    <div class="nn"><span>MATRICULE : <span id="nn">{{ $eleve->matricule }}</span></span>
                    </div>
                    <div class="card-front-body">
                        <div class="avatar-container">
                            <!-- <img id="qr-code" src="" alt=""> -->
                            @if ($eleve->avatar !== null)
                                <img id="avatar" src="{{ asset('storage/profiles/employers/' . $eleve->avatar) }}"
                                    alt="avatar" />
                            @else
                                @if ($eleve->sexe === 'M')
