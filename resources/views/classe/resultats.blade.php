            ...
            <div class="shadow-2xl relative bg-white rounded-5 p-5 w-full  z-20">
                <div id="printable" class="flex flex-col px-0 pt-0 w-full">
                    <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                        ...
                        <caption
                            class="font-bold pb-4 text-3 sm:text-4 text-center uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-base border-b-solid tracking-none whitespace-nowrap text-slate-500">
