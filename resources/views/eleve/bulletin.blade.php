...
@section('content')
    ...
    <div id='print' class=" flex flex-col gap-5 md:p-5">
        ...
        <x-eleve-profile-header :data="$eleve" :print="true" :index="$index" :eleves="$eleves" :pagename="$page_name"
            :annee="$annee_scolaire"> </x-eleve-profile-header>
            ...
            <div class="w-full flex flex-row justify-between">
                <div class="container w-full flex justify-center">
                    @if (
                                ...
                                <table id="printable" class="border-2xl print:w-60 border-collapse text-xs m-5">
                                    <thead>
                                        ...
                                        <th colspan="12" class="border p-1 px-2 uppercase text-left">
                                            ...
                                            <span class="upercase w-full">Classe :
                                                {{ $eleve->classe()->niveau->nom . ' ' . $eleve->classe()->nom }}</span>
                                            <br>
                                    ...
                                    <tbody>
                                        @for ($i = 0; $i < $periode1->count(); $i++)
                                            ...
                                            @endphp
                                            <tr>
                                                <td class="border p-0.5 text-left uppercase"> {{ $examenT1[$i]->nom }}
                                                </td>
                                                <td class="border p-0.5 text-center font-bold"> {{ $periode1[$i]->total }}
                                                </td>
                                                <td class="border p-0.5 text-center"> {{ $periode1[$i]->note }} </td>
                                                <td class="border p-0.5 text-center"> {{ $periode2[$i]->note }} </td>
                                                <td class="border p-0.5 text-center font-bold"> {{ $examenT1[$i]->total }}
                                                </td>
                                                ...
                                                <td class="border p-0.5 text-center font-bold"> {{ $periode3[$i]->total }}
                                                </td>
                                                <td class="border p-0.5 text-center"> {{ $periode3[$i]->note }} </td>
                                                <td class="border p-0.5 text-center"> {{ $periode4[$i]->note }} </td>
                                                <td class="border p-0.5 text-center font-bold"> {{ $examenT2[$i]->total }}
                                                </td>
                                                ...
                                                <td class="border p-0.5 text-center font-bold"> {{ $examenT3[$i]->total }}
                                                </td>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border p-0.5 font-normal text-center">
                                                {{ round(($noteP1 * 100) / $maxP1, 1) }}%</td>
                                            <td class="border p-0.5 font-normal text-center">
                                                {{ round(($noteP2 * 100) / $maxP2, 1) }}%</td>
                                            <td class="border p-0.5 font-normal text-center bg-slate-400"></td>
                                            <td class="border p-0.5 font-normal text-center">
                                            ...
                                            <td class="border p-0.5 font-normal text-center bg-slate-400"></td>
                                            <td class="border p-0.5 font-normal text-center">
                                                {{ round(($noteP3 * 100) / $maxP3, 1) }}%</td>
                                            <td class="border p-0.5 font-normal text-center">
                                                {{ round(($noteP4 * 100) / $maxP4, 1) }}%</td>
                                            <td class="border p-0.5 font-normal text-center bg-slate-400"></td>
                                            <td class="border p-0.5 font-normal text-center">
                                            ...
                                            <td class="border p-0.5 font-normal text-center bg-slate-400"></td>
                                            <td class="border p-0.5 font-normal text-center">
                                                {{ round(($noteGeneral * 100) / $maxGeneral, 1) }}%</td>
                                        </tr>
                                        @php
                                        ...
                                        <tr>
                                            ...
                                            <td class="border p-0.5 font-normal text-center">
                                                {{ conduite(round(($noteP2 * 100) / $maxP2, 1)) }}</td>
                                            <td class="border p-0.5 font-normal text-center bg-slate-400"></td>
                                            <td class="border p-0.5 font-normal text-center bg-slate-400"></td>
                                            {{-- <td class="border p-0.5 font-normal text-center" >{{ round($noteExT1 * 100 / $maxExT1, 1) }}%</td> --}}
                                            <td class="border p-0.5 font-normal text-center bg-slate-400"></td>
                                            <td class="border p-0.5 font-normal text-center">
                                                {{ conduite(round(($noteTri1 * 100) / ($maxExT1 * 2), 1)) }}</td>

                                            <td class="border p-0.5 font-normal text-center bg-slate-400"></td>
                                            <td class="border p-0.5 font-normal text-center">
                                                {{ conduite(round(($noteP3 * 100) / $maxP3, 1)) }}</td>
                                            <td class="border p-0.5 font-normal text-center">
                                                {{ conduite(round(($noteP4 * 100) / $maxP4, 1)) }}</td>
                                            <td class="border p-0.5 font-normal text-center bg-slate-400"></td>
                                            <td class="border p-0.5 font-normal text-center bg-slate-400"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border p-0.5 font-normal text-center">
                                                ...
                                                @else
                                                    @if (Auth::user()->isEnseignant())
                                                        <a href="{{ route('conduites.link', [$eleve->id, $p1->id]) }}"
                                                            class="text-blue-500 text-5"
                                                            title="enregistrer la conduite">+</a>
                                                    @else
                                            ...
                                            <td class="border p-0.5 font-normal text-center">
                                                ...
                                                @else
                                                    @if (Auth::user()->isEnseignant())
                                                        <a href="{{ route('conduites.link', [$eleve->id, $p2->id]) }}"
                                                            class="text-blue-500 text-5"
                                                            title="enregistrer la conduite">+</a>
                                                    @else
                                                        <span title="Consuite Indisponible">CI</span>
                                            ...
                                            <td class="border p-0.5 font-normal text-center">
                                                ...
                                                @else
                                                    @if (Auth::user()->isEnseignant())
                                                        <a href="{{ route('conduites.link', [$eleve->id, $p3->id]) }}"
                                                            class="text-blue-500 text-5"
                                                            title="enregistrer la conduite">+</a>
                                                    @else
                                                        <span title="Consuite Indisponible">CI</span>
                                            ...
                                            <td class="border p-0.5 font-normal text-center">
                                                ...
                                                @else
                                                    @if (Auth::user()->isEnseignant())
                                                        <a href="{{ route('conduites.link', [$eleve->id, $p4->id]) }}"
                                                            class="text-blue-500 text-5"
                                                            title="enregistrer la conduite">+</a>
                                                    @else
                                                        <span title="Consuite Indisponible">CI</span>
                                            ...
                                            <td class="border p-0.5 font-normal text-center">
                                                ...
                                                @else
                                                    @if (Auth::user()->isEnseignant())
                                                        <a href="{{ route('conduites.link', [$eleve->id, $p5->id]) }}"
                                                            class="text-blue-500 text-5"
                                                            title="enregistrer la conduite">+</a>
                                                    @else
                                                        <span title="Consuite Indisponible">CI</span>
                                            ...
                                            <td class="border p-0.5 font-normal text-center">
                                                ...
                                                @else
                                                    @if (Auth::user()->isEnseignant())
                                                        <a href="{{ route('conduites.link', [$eleve->id, $p6->id]) }}"
                                                            class="text-blue-500 text-5"
                                                            title="enregistrer la conduite">+</a>
                                                    @else
                                                        <span title="Consuite Indisponible">CI</span>
                                        ...
                                        <tr>
                                            <td colspan="24" class="border p-4">
                                                <form class="mr-4 flex flex-row justify-between"
                                                    action="{{ route('resultat.bulletin.store', [$annee_scolaire->id, $eleve->id]) }}"
                                                    method="post">
                                                        ...
                                                        @if ($decision === null)
                                                            <div class="flex flex-row gap-1 items-center">
                                                                @if (Auth::user()->isEnseignant())
                                                                    ...
                                                                    @else
                                                                        <x-input :submitOnChange="true" type="radio"
                                                                            name="decision" value="passe"></x-input>
                                                                    @endif
                                                                @else
                                                                    @if ($pourcAnnee >= env('REUSSITE'))
                                                                        <x-input disabled checked type="radio"
                                                                            name="decision" value="passe"></x-input>
                                                                    @else
                                                                        <x-input disabled type="radio" name="decision"
                                                                            value="passe"></x-input>
                                                                    @endif
                                                                @endif
                                                                <span class="uppercase">: L'eleve Passe dans la classe
                                                                    supperieure.</span>
                                                            </div>
                                                            <div class="flex flex-row gap-1 items-center">
                                                                @if (Auth::user()->isEnseignant())
                        ...
                        @else
                            <p class="text-bold text-2xl text-red-500 text-center pt-5 pb-3">
