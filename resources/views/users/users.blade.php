        ...
        @if (isset($self))
            ...
            <form method="PUT" action="{{ route('users.update', $self->id) }}">
                ...
                <div>
                    ...
                    <x-input id="matricule" class="block mt-1 w-full" type="text" name="matricule" :value="$self->employer->matricule"
                        readonly required />
                </div>
                ...
                <div class="mt-4">
                    ...
                    <x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="$self->email"
                        readonly required />
                </div>
        ...
        @else
            ...
            <form method="POST" action="{{ route('users.store') }}">
                ...
                <div>
                    <x-label for="matricule" :value="__('Matricule de L\'Employé')" />
                    @if (isset($employe))
                        <x-input id="matricule" class="block mt-1 w-full" type="text" name="matricule" :value="$employe->matricule"
                            readonly required />
                    @else
